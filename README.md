...
- [01. 프로젝트 개요](#1.-프로젝트-개요)
- [02. 국내외 유사 서비스와 차별성](#2.-국내외-유사-서비스와-차별성)
- [03. 프로젝트 설계](#3.-프로젝트-설계)
- [04. 프로젝트 수행 결과](#4.-프로젝트-수행-결과)
- [05. 프로젝트 수행 체계](#5.-프로젝트-수행-체계)
- [06. 참고문헌](#6.-참고문헌)
...
| --------------- | ---------------- | ------------------------------------------------------------ | ----------------------- | -------------------- |
| REQ-001         | 회원 가입        | 사용자는 카페 관리 사이트에 회원 또는 사업자로 가입할 수 있어야 함 | 상                      |                      |
| REQ-002         | 회원 탈퇴        | 사용자는 원한다면 언제든지 탈퇴할 수 있어야 함               | 상                      |                      |
| REQ-003         | 로그인           | 등록된 회원은 아이디(이메일)와 비밀번호를 사용해 로그인할 수 있어야 함 | 상                      |                      |
| REQ-004         | 로그아웃         | 회원은 언제든지 로그아웃할 수 있어야 함                      | 상                      |                      |
| REQ-005         | 비밀번호 변경    | 회원은 비밀번호를 변경할 수 있어야 함                        | 상                      |                      |
| REQ-006         | 아이디 찾기      | 아이디를 분실한 경우 이름과 전화번호로 찾을 수 있어야 함     | 상                      |                      |
| REQ-007         | 비밀번호 찾기    | 비밀번호를 분실한 경우 아이디, 이름, 전화번호로 찾을 수 있어야 함 | 상                      |                      |
| REQ-008         | 개인 정보 수정   | 사용자는 언제든지 개인 정보를 수정할 수 있어야 함            | 중                      |                      |
| REQ-009         | 매장 조회        | 사용자는 다양한 조건으로 매장을 검색할 수 있어야 함          | 상                      |                      |
| REQ-010         | 메뉴 조회        | 사용자는 다양한 조건으로 메뉴를 검색할 수 있어야 함          | 상                      |                      |
| REQ-011         | 옵션 조회        | 사용자는 메뉴를 선택한 후 옵션을 확인할 수 있어야 함         | 상                      |                      |
| REQ-012         | 리뷰 작성        | 사용자는 즐겨찾기 된 조합에 대해 카페에 별점 및 리뷰를 작성할 수 있어야 함 | 상                      |                      |
| REQ-013         | 즐겨찾기 등록    | 사용자는 본인의 메뉴 조합으로 즐겨찾기를 등록할 수 있어야 함 | 상                      |                      |
| REQ-014         | 즐겨찾기 수정    | 사용자는 즐겨찾기에 등록한 정보를 수정할 수 있어야 함        | 상                      |                      |
| REQ-015         | 즐겨찾기 삭제    | 사용자는 즐겨찾기에 등록한 조합을 삭제할 수 있어야 함        | 상                      |                      |
| REQ-016         | 로그인 제한      | 일정 시간 내, 사용자의 로그인 실패 횟수가 5회 이상인 경우, 해당 회원 아이디의 로그인이 5분 동안 제한됨. | 중                      |                      |
| REQ-017         | 로그인 내역 기록 | 사용자가 회원 로그인을 시도하면 그 내역이 기록되어야 함      | 중                      |                      |

| **요구사항 ID** | **요구사항명** | **요구사항 내용**                                            | **중요도 (상/중/하) ** | **난이도(상/중/하)** |
| --------------- | -------------- | ------------------------------------------------------------ | ---------------------- | -------------------- |
| REQ-018         | 매장 등록 문의 | 사업자인 사용자는 본인 매장에 대한 정보를 신청할 수 있어야 함 | 상                     |                      |
| REQ-019         | 매장 삭제 문의 | 폐업 시 언제든지 매장 정보를 삭제할 수 있어야 함             | 상                     |                      |
| REQ-020         | 메뉴 등록      | 사업자인 사용자 본인은 언제든지 메뉴를 등록할 수 있어야 함   | 상                     |                      |
| REQ-021         | 메뉴 수정      | 사업자인 사용자 본인은 언제든지 메뉴를 수정할 수 있어야 함   | 상                     |                      |
| REQ-022         | 메뉴 삭제      | 사업자인 사용자 본인은 언제든지 메뉴를 삭제할 수 있어야 함   | 상                     |                      |
| REQ-023         | 인기 메뉴 등록 | 사업자인 사용자 본인은 언제든지 인기 메뉴를 등록할 수 있어야 함 | 중                     |                      |
| REQ-024         | 오픈 여부      | 사업자인 사용자 본인은 오픈 여부에 대해 언제든지 수정할 수 있어야 함 | 상                     |                      |
| REQ-025         | 옵션 등록      | 사업자인 사용자 본인은 언제든지 메뉴 옵션을 등록할 수 있어야 함 | 상                     |                      |
| REQ-026         | 옵션 수정      | 사업자인 사용자 본인은 언제든지 옵션을 수정할 수 있어야 함   | 상                     |                      |
| REQ-027         | 옵션 삭제      | 사업자인 사용자 본인은 언제든지 옵션을 삭제할 수 있어야 함   | 상                     |                      |
| REQ-028         | 카테고리 등록  | 사업자인 사용자 본인은 언제든지 메뉴 별 카테고리를 등록할 수 있어야 함 | 상                     |                      |
| REQ-029         | 카테고리 수정  | 사업자인 사용자 본인은 언제든지 메뉴 별 카테고리를 수정할 수 있어야 함 | 상                     |                      |
| REQ-030         | 카테고리 삭제  | 사업자인 사용자 본인은 언제든지 메뉴 별 카테고리를 삭제할 수 있어야 함 | 상                     |                      |
| REQ-031         | 코멘트 등록    | 사업자인 사용자 본인은 언제든지 회원이 남긴 리뷰에 코멘트를 등록할 수 있어야 함 | 상                     |                      |

| **요구사항 ID** | **요구사항명**  | **요구사항 내용**                                            | **중요도 (상/중/하) ** | **난이도 (상/중/하)** |
| --------------- | --------------- | ------------------------------------------------------------ | ---------------------- | --------------------- |
| REQ-032         | 회원 관리       | 관리자는 회원이나 사업자를 수정, 삭제할 수 있어야 함         | 상                     |                       |
| REQ-033         | 블랙리스트 관리 | 관리자는 회원이나 사업자를 블랙리스트 등록 및 삭제할 수 있어야 함 | 중                     |                       |
| REQ-034         | 매장 관리       | 관리자는 등록된 매장 정보를 수정 및 삭제할 수 있어야 함      | 상                     |                       |
| REQ-035         | 휴면 계정 관리  | 회원을 휴면 계정 상태로 변경하거나 휴면 해제를 할 수 있어야 함 | 중                     |                       |
